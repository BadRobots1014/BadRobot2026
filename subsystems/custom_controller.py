...
button_to_string = {0 : "UNDEFINED", 1 : "SQUARE", 2 : "CROSS", 3 : "CIRCLE", 4 : "TRIANGLE", 5 : "L1", 6 : "R1", 7 : "L2", 8 : "R2", 9 : "SHARE"}
...
class CustomController(CommandGenericHID):
    ...
    def __init__(self, port: int):
        ...
        self._bounded_buttons_publisher = self._controller_table.getStringTopic("BoundedButtons").publish()
